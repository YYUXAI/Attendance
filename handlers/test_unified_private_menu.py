...
def test_private_actions_inline_preserves_attendance_actions() -> None:
    ...
    assert markup.inline_keyboard[0][0].callback_data == "att:register"
    assert markup.inline_keyboard[0][1].callback_data == "att:profile"
    assert markup.inline_keyboard[1][0].callback_data == "att:export"
